...
FROM salesQuants,  countryCodes
where  salesQuants.countryName = countryCodes.EnglishShortName
...
SELECT totalQuantity, alpha3Code
FROM salesQuants,  modCountryCodes
where  salesQuants.countryName = modCountryCodes.EnglishShortName
